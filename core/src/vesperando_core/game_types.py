...
class ArtesEntry(ctypes.Structure):
    ...
    _fields_ = [
        ...
        ("fire_elemental", ctypes.c_uint32),
        ("earth_elemental", ctypes.c_uint32),
        ("wind_elemental", ctypes.c_uint32),
        ("water_elemental", ctypes.c_uint32),
        ("light_elemental", ctypes.c_uint32),
        ("dark_elemental", ctypes.c_uint32),
        ("unknown_elemental", ctypes.c_uint32),
        ...
        # Enemy Type Power
        ("vs_human_elemental", ctypes.c_uint32),
        ("vs_beast_elemental", ctypes.c_uint32),
        ("vs_bird_elemental", ctypes.c_uint32),
        ("vs_magic_power", ctypes.c_uint32),
        ("vs_plant_elemental", ctypes.c_uint32),
        ("vs_aquatic_power", ctypes.c_uint32),
        ("vs_insect_elemental", ctypes.c_uint32),
        ("vs_inorganic_power", ctypes.c_uint32),
        ("vs_scale_elemental", ctypes.c_uint32),
        ("vs_small_elemental", ctypes.c_uint32),
        ("vs_normal_elemental", ctypes.c_uint32),
        ("vs_big_elemental", ctypes.c_uint32),
        ("vs_large_elemental", ctypes.c_uint32),
        # Status Effects
        ...
        # Time/Weather Power
        ("day_weather_elemental", ctypes.c_uint32),
        ("cloudy_weather_elemental", ctypes.c_uint32),
        ("fog_weather_elemental", ctypes.c_uint32),
        ("night_weather_elemental", ctypes.c_uint32),
        ("rain_weather_elemental", ctypes.c_uint32),
        ("snow_weather_elemental", ctypes.c_uint32),
        ("sandstorm_weather_elemental", ctypes.c_uint32),
        ("evening_weather_elemental", ctypes.c_uint32),
