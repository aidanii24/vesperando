...
class Weights:
    ...
    ITEM_PRICE_SUB_STAT_PAIR_MAIN_VALUE = 0.30
    ITEM_PRICE_SUB_STAT_PAIR_SUB_VALUE = 0.30
    ITEM_PRICE_SUB_RELATED_STAT_VALUE = 0.15
    ITEM_PRICE_NON_ACC_AUX_STAT_VALUE = 0.05
    ...
    ITEM_SYNTHESIS_CONSUMABLE_AS_MATERIAL: float = 0.3
    SHOP_CANDIDACY = 0.1
